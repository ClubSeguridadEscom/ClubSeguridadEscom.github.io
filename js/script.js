...
class Matrix {
    ...
    dibujar(ctx) {
        ...
        if (code.includes(this.valor)) {
            ctx.fillStyle = "rgba(200,250,0)" // Establece el color de relleno de la fuente en verde
        } else {
...
function myFunction() {
  ...
  document.addEventListener("keypress", function(event) {
    if (event.keyCode == 13) {
      alert('La pagina tiene varios secretos, podras encontrarlos todos?');
      console.log("Hackeado pa")
    }
  });
